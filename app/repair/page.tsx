...
export default function RepairPage() {
  const [formData, setFormData] = useState({
    ...
    location: '',
    priority: 'Normal', 
    requester_name: 'พนักงาน A (Default)', 
    requester_email: 'employee.a@email.com', 
            ...
            <div className="bg-[#1A1A1A] p-6 rounded-lg border border-gray-800">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="text" name="requester_name" value={formData.requester_name} readOnly className="w-full bg-[#121212] border border-gray-700 rounded-md p-3 text-gray-500 cursor-not-allowed focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm text-gray-400 mb-1">อีเมล (Email)</label>
                  <input type="email" name="requester_email" value={formData.requester_email} readOnly className="w-full bg-[#121212] border border-gray-700 rounded-md p-3 text-gray-500 cursor-not-allowed focus:outline-none" />
                </div>
                <div>
